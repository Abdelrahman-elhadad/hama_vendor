...
public class ProductsViewModel extends ViewModel {
    ...
    public void getProducts(Context context, int page) {
        productRepo.getProducts(context, page, sort_key, category_level_1, category_level_2, category_level_3, type_of_price, range_price_from, range_price_to, languageResponseMutableLiveData);
    }
